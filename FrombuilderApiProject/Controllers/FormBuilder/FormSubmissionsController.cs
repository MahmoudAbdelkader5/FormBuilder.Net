...
namespace FormBuilder.API.Controllers
{
    ...
    public class FormSubmissionsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetDraft([FromQuery] int formBuilderId, [FromQuery] int projectId, [FromQuery] string? submittedByUserId = null)
        {
            if (formBuilderId <= 0)
            ...
            var result = await _formSubmissionsService.GetDraftAsync(formBuilderId, projectId, userId);
            return StatusCode(result.StatusCode, result);
        }
            ...
            [FromQuery] int? seriesId = null)
        {
            ...
            var result = await _formSubmissionsService.GetOrCreateDraftAsync(formBuilderId, projectId, userId, seriesId);
            return StatusCode(result.StatusCode, result);
        }
        ...
        public async Task<IActionResult> CreateDraft(
            [FromBody] CreateDraftDto? createDraftDto = null,
            ...
            [FromQuery] string? submittedByUserId = null)
        {
            ...
            var result = await _formSubmissionsService.CreateDraftAsync(createDraftDto);
            return StatusCode(result.StatusCode, result);
        }
        ...
        [AllowAnonymous]
        public async Task<IActionResult> SubmitById(int id)
        {
            if (id <= 0)
        ...
        [AllowAnonymous]
        public async Task<IActionResult> GetSigningUrlById(int id)
        {
            if (id <= 0)
                return BadRequest(new ApiResponse(400, "Submission ID is required"));

            var requestedByUserId = ResolveSubmittedByUserId(forcePublic: false);
            var result = await _formSubmissionsService.GetSigningUrlAsync(id, requestedByUserId);
        ...
        /// </summary>
        [HttpPost("approve")]
        public async Task<IActionResult> ApproveSubmission([FromBody] ApproveSubmissionDto dto)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ApiResponse(400, "Invalid data", ModelState));
            ...
            var result = await _formSubmissionsService.ApproveSubmissionAsync(dto);
            return StatusCode(result.StatusCode, result);
        }
        ...
        /// </summary>
        [HttpPost("reject")]
        public async Task<IActionResult> RejectSubmission([FromBody] RejectSubmissionDto dto)
        {
            if (!ModelState.IsValid)
                return BadRequest(new ApiResponse(400, "Invalid data", ModelState));
            ...
            var result = await _formSubmissionsService.RejectSubmissionAsync(dto);
            return StatusCode(result.StatusCode, result);
        }
        ...
        public async Task<IActionResult> CheckGridData(int id)
        {
            var submission = await _formSubmissionsService.GetByIdAsync(id);
        ...
        public async Task<IActionResult> SaveFormSubmissionData([FromBody] SaveFormSubmissionDataDto saveDto)
        {
            ...
            var result = await _formSubmissionsService.SaveFormSubmissionDataAsync(saveDto, resolvedUserId);
            return StatusCode(result.StatusCode, result);
        }
    }
}
