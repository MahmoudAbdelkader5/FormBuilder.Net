...
################ Module Preamble ################
# ----------- BEGIN CHANGELOG BY SAP -----------
#
# All changes by SAP to the original file are documented in this section.
#
# 2024-11-28
# ----------
# - Inherit with @ISA modification instead of 'use base'
#
# ----------- END CHANGELOG BY SAP -----------
